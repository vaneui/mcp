...
Semantic page section. Flex column + padding + responsive by default.

Source: `vaneui-web/app/docs/data/layout-components/section.tsx` —
live demos at https://vaneui.com/docs/layout-components/section
