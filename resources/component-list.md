...
Bullet / numbered list. Pair with ListItem. decimal prop switches to <ol>.

Source: `vaneui-web/app/docs/data/typography-components/list.tsx` —
live demos at https://vaneui.com/docs/typography-components/list
