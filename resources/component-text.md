...
Body text (<p>). Size, weight, alignment, transform, and appearance props.

Source: `vaneui-web/app/docs/data/typography-components/text.tsx` —
live demos at https://vaneui.com/docs/typography-components/text
