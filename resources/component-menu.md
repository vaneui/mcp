...
Dropdown menu with full keyboard navigation. Uses MenuItem, MenuLabel, and Divider as children.

Source: `vaneui-web/app/docs/data/overlay-components/menu.tsx` —
live demos at https://vaneui.com/docs/overlay-components/menu
