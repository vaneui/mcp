...
Square icon-only button. Supports href, loading state, and all Button props.

Source: `vaneui-web/app/docs/data/basic-components/iconbutton.tsx` —
live demos at https://vaneui.com/docs/basic-components/icon-button
