...
Primary page heading (<h1>). Responsive font-size.

Source: `vaneui-web/app/docs/data/typography-components/pagetitle.tsx` —
live demos at https://vaneui.com/docs/typography-components/page-title
