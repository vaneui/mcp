...
Form field label. Flex row with gap, sm size, inherit appearance by default.

Source: `vaneui-web/app/docs/data/basic-components/label.tsx` —
live demos at https://vaneui.com/docs/basic-components/label
