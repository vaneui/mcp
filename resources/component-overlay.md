...
Fullscreen portal-rendered backdrop. Click-to-close and optional blur.

Source: `vaneui-web/app/docs/data/overlay-components/overlay.tsx` —
live demos at https://vaneui.com/docs/overlay-components/overlay
