...
Floating element using CSS Anchor Positioning. 12 placement options, width matching, click-outside dismissal.

Source: `vaneui-web/app/docs/data/overlay-components/popup.tsx` —
live demos at https://vaneui.com/docs/overlay-components/popup
