...
Vertical flexbox (no padding). Pair with Row for column layouts.

Source: `vaneui-web/app/docs/data/layout-components/col.tsx` —
live demos at https://vaneui.com/docs/layout-components/col
