...
Image with VaneUI styling (size, shape, border, shadow, object-fit).

Source: `vaneui-web/app/docs/data/basic-components/img.tsx` —
live demos at https://vaneui.com/docs/basic-components/img
